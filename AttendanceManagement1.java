...
public class AttendanceManagement1 {
    public static void main(String[] args) {a
        Scanner scanner = new Scanner(System.in);
        int numStudents = 0;
        int numClasses = 0;
        String[] studentNames = new String[200];
        String[] classNames = new String[200];
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    String studentName = scanner.nextString();
                ...
                case 3:
                    System.out.print("Enter student name: ");
                    studentName = scanner.nextString();
                    System.out.print("Enter class name: ");
                    className = scanner.nextString();
                    int studentIndex = -1;
                    int classIndex = -1;
                    for (int i = 0; i < numStudents; i++) {
